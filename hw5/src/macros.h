...
#define getIDOffset(idNode) (getIDTypeDescriptor(idNode)->offset)
#define setIDOffset(idNode, val) (getIDTypeDescriptor(idNode)->offset = (val))
#define getIDGlobal(idNode) (getIDTypeDescriptor(idNode)->global)
#define setIDGlobal(idNode, val) (getIDTypeDescriptor(idNode)->global = (val))
